define([
    ...
    "dojo/text",
    "mendix/validator",
    "CKEditorForMendixExtended/widget/lib/jquery",
    "CKEditorForMendixExtended/widget/lib/ckeditor",
    "dojo/text!CKEditorForMendixExtended/widget/templates/CKEditorForMendixExtended.html",
    "CKEditorForMendixExtended/widget/lib/jquery.oembed"
    ...
    return declare("CKEditorForMendixExtended.widget.CKEditorForMendixExtended", [_WidgetBase, _TemplatedMixin], {
        ...
        _createChildNodes: function(callback) {
            ...
            this.CKEditorForMendixExtendedNode.appendChild(domConstruct.create("textarea", {
        ...
        _addValidation: function(msg) {
            ...
            this.CKEditorForMendixExtendedNode.appendChild(this._alertdiv);
        },
...
require(["CKEditorForMendixExtended/widget/CKEditorForMendixExtended"]);
